  ...
  const modal=()=>{
    return <Backdrop>
      ...
      <div style={{width:'300px',display:'flex', margin:'10px 8px'}}>
        ...
        <input type='date' required onChange={(e)=>setPaymentDate(e.target.value)}  style={{
            height: '40px',
            width: '100%',
            fontSize: '1rem',
      ...
      <div style={{width:'300px',display:'flex', margin:'10px 8px'}}>
        ...
        <input type='number' required placeholder='Self Deposite' id = "self" onChange={(e)=>cvbn(e.target.value)}  style={{
      ...
      <div style={{width:'300px',display:'flex', margin:'10px 8px'}}>
        ...
        <input type='number' placeholder='Team Deposite' id = "team"  required
        onChange={(e)=>cvb(e.target.value)}  style={{
      ...
      <div style={{width:'300px',display:'flex', margin:'10px 8px'}}>
        ...
        <input type='text' required placeholder='TDS' onChange={(e)=>setTDS(e.target.value)} style={{
      ...
      <div style={{width:'300px',display:'flex', margin:'10px 8px'}}>
        ...
        <input type='text' required placeholder='Processing' onChange={(e)=>setProcessing(e.target.value)}  style={{
      ...
      <div style={{width:'300px',display:'flex', margin:'10px 8px'}}>
        ...
        <input type='text' required placeholder='Total Amount'  //onChange={(e)=>setTotalAmount(e.target.value)} 
      ...
      <div style={{width:'300px',display:'flex', margin:'10px 8px'}}>
        ...
        <input type='text' required placeholder='Details' onChange={(e)=>setDetail(e.target.value)}  style={{
